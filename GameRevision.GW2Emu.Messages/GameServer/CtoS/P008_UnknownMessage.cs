...
{
    public class P008_UnknownMessage : GenericTriggerableMessage
    {
        ...
        public struct Struct14
        {
            ...
            {
                this.Unknown15 = deserializer.ReadVarint();
                this.Unknown16 = deserializer.ReadVarint();
                if (deserializer.ReadBoolean())
                {
                    this.Unknown17 = new Optional<WorldPosition>(deserializer.ReadWorldPosition());
                }
                else
                {
                    this.Unknown17 = null;
